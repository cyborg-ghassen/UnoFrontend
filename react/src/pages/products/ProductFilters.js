...
const ProductFilters = ({setShow, isOffcanvas, getProducts}) => {
    ...
    const handleFilterOptions = (e, k) => {
        ...
        if (type === 'checkbox') {
            ...
            console.log(options)
            query.set(name, options.filter(option => option.name === k).map(option => option.value))
            getProducts(query)
                ...
                <Card.Body className="py-0">
                    ...
                    <ul className="list-unstyled">
                        ...
                        <FilterItem
                            ...
                            setFilterOptions={setFilterOptions}
                            handleFilterOptions={(e) => {
                                handleFilterOptions(e, "category")
                            }}
