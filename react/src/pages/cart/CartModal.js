			...
			<Modal.Body>
				...
				<Form className={"mt-3"}>
					...
					<Form.Group className="mt-3 d-inline-flex">
						<Form.Label className="me-3">Mode de paiement:</Form.Label>
						<Form.Check
							type={"radio"}
					...
					<Form.Group className="mt-3 d-inline-flex">
						<Form.Label className="me-3">Mode de livraison:</Form.Label>
						<Form.Check
							type={"radio"}
							value={"domicile"}
							checked={formData.shipment_method === "domicile"}
						...
						<Form.Check
							type={"radio"}
							value={"magasin"}
							checked={formData.shipment_method === "magasin"}
							label={"Livraison au magasin"}
							onChange={({target}) => handleChange(target)}
							name={"shipment_method"}
						/>
					</Form.Group>
